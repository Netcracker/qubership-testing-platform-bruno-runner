#!/usr/bin/env bats
# Unit tests for scripts/tools/b3_trace.sh (qubership-testing-platform-common-scripts) —
# B3 trace/span id generation, exercised here since this runner is its only current consumer.
#
...
setup() {
    ...
    source "$REPO_ROOT/scripts/tools/b3_trace.sh"
}
