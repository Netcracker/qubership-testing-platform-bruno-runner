...
| BRUNO_FOLDERS                       | string  | no        | ``                                        | Comma-separated list of folders inside the `collections/` directory. If set, only these collections will be run.<br>Example: `BRUNO_FOLDERS="collectionA,collectionB"`. |
